<%@ Page Language="VB" MasterPageFile="~/mstr.master" AutoEventWireup="false" CodeFile="dispstud.aspx.vb" Inherits="dispstud" title="Untitled Page" %>
...
<table align="center" 
    ...
    <tr>
        <td style="height: 25px; width: 209px;"><asp:Label ID="Label1" runat="server" 
                Text="Enter Enrollment_id :" style="font-size: 13pt"></asp:Label>
            <br />
            <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button3" runat="server" Height="40px" Text="Search" 
            Width="140px" />
        &nbsp;
        <asp:Button ID="Button4" runat="server" Height="40px" Text="Search in College" 
            Width="180px" />
        <br />
            ...
            <asp:GridView ID="gv1" runat="server" BackColor="#CCCCCC" BorderColor="#999999" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Standard">
                        <ItemTemplate>
                            <asp:Label ID="Label3" runat="server" Text='<%# bind("Standard") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="E - Mail">
                        <ItemTemplate>
                            <asp:Label ID="Label3" runat="server" Text='<%# bind("E_mail") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Date Of Birth">
                        <ItemTemplate>
                            <asp:Label ID="Label3" runat="server" Text='<%# bind("Date_of_birth") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Year Of Joining">
                        <ItemTemplate>
                            <asp:Label ID="Label3" runat="server" Text='<%# bind("Year_of_joining") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
